    ...
    <section class="py-16">
        <div class="container px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="overflow-hidden bg-white border border-blue-100 shadow-lg rounded-xl hover-lift group">
                    <div class="overflow-hidden h-96">
                        ...
                        @else
                            <div class="flex items-center justify-center h-full bg-gradient-to-br from-blue-500 to-blue-700">
